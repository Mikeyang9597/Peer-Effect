...
*drop 
drop higher_ed_pseudo_id person_key zip* us* begin* end* first* active* dob ada* county* state* aian baa race_unk_flag record* asian white nhopi academic* ethnicity*
